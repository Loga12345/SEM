...
<body>
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url(assets/img/book/book1.jpg)">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">Edit Details</h2>


				<input type="hidden" name="action" value="view">
					<center>
          <form action="EditLibrarianController.php?GetLibrarian=<?php echo $librarianID ?>" method="post">
						<table>
							<tr>
								<th>Librarian ID</th>
  ...
  {
	if (confirm("Please confirm all your details are correct"))
	{
