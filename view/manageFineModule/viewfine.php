				...
				<div class="table-wrapper-scroll-y my-custom-scrollbar">	
					...
					<table class="table table-bordered table-striped mb-0">
					  <tr id="list">
						...
						<td style="background-color:#00aea6; color: white"><b>FINE</b></td>
						<td style="background-color:#00aea6; color: white"><b>TOTAL PRICE</b></td>
					  ...
					  <?php
						...
						{
							$ISBN = $row['id'];
							$Book_title = $row['borrower_name'];
							$Book_author = $row['days'];
							$publication_date = $row['fine'];
					  ...
					  ?>
						<tr id="list">
							...
							<td><a id="greenlinks" href="updatefine.php?GetBook=<?php echo $ISBN ?>">Edit</a></td>
                            <td><a id="redlinks" onclick="delete()" href="deleteFineController.php?Delete=<?php echo $ISBN ?>"><b>Delete</b></a></td>
						</tr>
					  <?php
						}
					  ?>
