				...
				<input type="hidden" name="action" value="insert">
					<center>
						...
						<th Colspan="3" style="text-align:center; background-color:#00aea6"><h5><b>Total Fine Record</b></h5></th>
							<tr>
								<th>ID</th>
								<td><input type="text" id="ISBN" name="ISBN" placeholder="ID"></td>
							</tr>
							
							<tr>
								<th>Borrrower Name</th>
								<td><input type="text" id="Book_title" name="Book_title" placeholder="Borrower Name"></td>
							</tr>
							
							<tr>
								<th>Total days after due</th>
								<td><input type="text" id="Book_author" name="Book_author" placeholder="Total days "></td>
							</tr>
							
							<tr>
								<th>Fine Amount per day</th>
								<td><input type="text" id="publication_date" name="publication_date" value= "5" </td>
							</tr>
							
							<tr>
								<th>Total Fine Amount</th>
								<td><input type="text" id="totalPages" name= "totalPages" value="" ></input></td>
							</tr>
						</table><br>
