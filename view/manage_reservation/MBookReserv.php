          ...
          <div class="carousel-item active" style="background-image: url(assets/img/book/book1.jpg)">
            <div class="carousel-container">
              <div class="container">
                ...
                <form action="controller/createBReserv_ctrl.php" method="post">
                  <h5 style="color:black;" class="display-4 text-center"><b>Create</b></h5><hr>
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" 
                          ...
                          id="BorrowDate" 
                          name="BorrowDate"  
                          value="<?php if (isset($_GET['BorrowDate'])) echo($_GET['BorrowDate']); ?>"
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" 
                          ...
                          id="ReturnDate" 
                          name="ReturnDate" 
                          value="<?php if (isset($_GET['ReturnDate'])) echo($_GET['ReturnDate']); ?>"
