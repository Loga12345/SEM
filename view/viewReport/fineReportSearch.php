						          ...
						          <table class="table table-bordered table-striped mb-0">
												...
												<?php
                                                  ...
                                                  if (isset($_POST["search_btn"])) {
                                                      $str = $_POST["search"];
                                                      $sth = $con->prepare("SELECT * FROM `calculatefine` WHERE borrower_name = '$str'  ");
													...
													<tr id="list">
										                ...
										                <td><?php echo $row->total ?></td>
              							                <td><a id="greenlinks" href="viewReportFine.php?GetFineReport=<?php echo $row->id ?>">View</a></td>
                                                        </tr>
                                                    <?php 
	                                                    }
    
		                                            else{
			                                            echo "Borrower name does not exist";
		                                            }
